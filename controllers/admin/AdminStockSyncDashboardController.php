...
class AdminStockSyncDashboardController extends ModuleAdminController
{
    ...
    public function renderView()
    {
       ...
       /** // Assign variables to template
        ...
        // Forzar valores para las estadísticas
$forced_queue_stats = [
    'total' => 10,
    'pending' => 3,
    'processing' => 1,
...
// Assign variables to template
$this->context->smarty->assign([
    'queue_stats' => $forced_queue_stats,
    'log_stats' => $forced_log_stats,
    'store_stats' => $forced_store_stats,
    'reference_stats' => $forced_reference_stats,
    'recent_logs' => $recent_logs,
    'recent_queue' => $recent_queue,
    'conflicts' => $conflicts,
    'discrepancies' => $discrepancies,
